...
| `status_poll_interval`             | 整数   | 检查【在线/游戏状态】的间隔时间（秒）。默认为 `60` 秒。                                                                                                                                                                  |
| `achievement_poll_interval`        | 整数   | 检查【成就状态】的间隔时间（秒）。默认为 `180` 秒。                                                                                                                                                                     |
...
| `private_name`                     | 字符串 | 当 `private_mode` 开启时，用来替换 Steam 昵称的自定义代称。如果留空，默认为“有人”。                                                                                                                                    |
